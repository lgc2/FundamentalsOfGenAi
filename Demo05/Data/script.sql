...
INSERT INTO products (title, category, summary, description) VALUES
    ('Burundi Coffee', 'arabic', 'A sweet and floral coffee with a clean finish', 'Burundi coffee is gaining popularity for its excellent quality. Grown at high altitudes, it has a clean and bright profile. The flavor often includes notes of floral honey, citrus, and red berries, with a delicate acidity and a medium body. It offers a sweet and pleasant cup that is very approachable.');

INSERT INTO products (title, category, summary, description) VALUES
    ('Ethiopian Harrar', 'arabic', 'A wild, fruit-forward coffee with a complex profile', 'Ethiopian Harrar is a dry-processed coffee with a strong, fruity flavor. It has a heavy body and a low acidity, with a taste that is often described as wild and complex. Common notes include blueberries, cocoa, and spices. It is a bold and rustic coffee that stands out with its unique, naturally fruity taste.');

INSERT INTO products (title, category, summary, description) VALUES
    ('Indian Monsooned Malabar', 'intense', 'A coffee with a unique, earthy, and nutty character', 'Monsooned Malabar coffee is a specialty of the Malabar Coast of India. The beans are exposed to monsoon winds and rain for several months, which causes them to swell and lose their original acidity. The resulting coffee is very low in acidity with a unique, heavy body and a pungent, earthy, and nutty flavor.');